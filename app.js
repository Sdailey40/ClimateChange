...
function createMap(city_layer,rng_1880_1910_layer,rng_2001_2017_array) {
  ...
  var myMap = L.map("map", {
    center: [0, 0],
    zoom: 5,
    layers: [lightmap, city_layer, rng_1880_1910_layer,rng_2001_2017_array]
  });
